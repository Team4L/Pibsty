...
public class StartScreen extends IScreen
{
	MenuButton startButton;
	MenuButton quitButton;
	MenuButton highScoresButton;

	StartScreen(OrthographicCamera camera)
	{
		super(camera);
	...
	private void InitialiseLevelObjects()
	{
		...
		gameObjects_.add(quitButton);
		spriteList_.add(quitButton._sprite);
	...
	public void Update(float dt) {
		...
		{
			isClosing = true;
			nextScreen = new TetrisLevel(camera_);
		...
		if (highScoresButton.isSelected)
		{
			isClosing = false;
			nextScreen = new HighScoresScreen(camera_);
			highScoresButton.isSelected = false;
		}
